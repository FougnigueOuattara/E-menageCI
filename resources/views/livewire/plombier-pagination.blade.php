<div class="justify-center border-gray-300 min-h-[60vh] mb-10">
    ...
    <div class="flex items-center bg-gray-300 justify-between px-4 py-4">
        <div class="px-2 py-1 bg-slate-200 rounded-md text-base font-medium text-slate-500 w-auto">
            Plomberie
        </div>
        <div class="flex items-center justify-center bg-gray-200 p-1 h-auto rounded w-1/6 text-center">
            <svg class="text-slate-500 dark:text-slate-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="20" height="24" fill="currentColor" viewBox="0 0 24 24">
